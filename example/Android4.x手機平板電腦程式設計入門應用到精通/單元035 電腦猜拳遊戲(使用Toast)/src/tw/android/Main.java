...
//				  			getString(R.string.playerDraw));
				Toast.makeText(Main.this, R.string.playerDraw, Toast.LENGTH_LONG)
					.show();
			}
			else if (iComPlay == 2) {
...
//							getString(R.string.playerLose));
				Toast.makeText(Main.this, R.string.playerLose, Toast.LENGTH_LONG)
					.show();
			}
				else {
...
//						  getString(R.string.playerWin));
				Toast.makeText(Main.this, R.string.playerWin, Toast.LENGTH_LONG)
					.show();
			}
		}
	};
